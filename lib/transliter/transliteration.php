<?php
// $Id: transliteration.inc,v 1.6.2.6 2009/11/29 15:59:06 smk Exp $
 ...
 *   Transliterated text.
 */
function transliteration_process($string, $unknown = '_', $source_langcode = 'ru') {
 ...
 */
function _transliteration_replace($ord, $unknown = '_', $langcode = 'ru') {
  static $map = array();
